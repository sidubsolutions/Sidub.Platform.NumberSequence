...
namespace Sidub.Platform.NumberSequence.Providers.Sequential
{
    ...
    /// <summary>
    /// Represents a sequential number sequence provider that stores the current state in memory as a short value.
    /// </summary>
    public class SequentialNumberSequenceInMemoryShortStateProvider : SequentialNumberSequenceShortStateProvider
    {
        ...
        public override Task<NumberSequenceValue<short>?> GetCurrentValue()
        {
            return Task.Run(() =>
            {
                ...
                return new NumberSequenceValue<short>(_currentState.Value);
            });
        }
        ...
        public override Task SetCurrentValue(NumberSequenceValue<short> value)
        {
            return Task.Run(() =>
            {
